...
export default function Footer() {
    return (
        <div className="container-fluid mfDiv" style={{ minHeight: "48px", boxSizing: "border-box" }}>
            <div style={{ width: "100%" }} className=" container-fluid ">
                <table className="row d-flex justify-content-around justify-content-between" style={{ margin: "0px 0px 0px 3vw" }}>
                    <td className="col-sm-12 col-md-6 col-lg-2">
                        {/* TRENDING SEARCHES */}
                        <th href="#action/3.1" className="footH">TRENDING SEARCHES</th>
                        <tr href="#action/3.1" className="footC">
                            Cars
                        </tr>
                        <tr href="#action/3.1" className="footC">
                            Flats for rent
                    ...
                    <td className="col-sm-12 col-md-6 col-lg-2">
                        {/* POPULAR CATEGORIES */}
                        <th href="#action/3.1" className="footH">POPULAR CATEGORIES</th>
                        <tr href="#action/3.1" className="footC">
                            Bikes
                        </tr>
                        <tr href="#action/3.1" className="footC">
                    ...
                    <td className="col-sm-12 col-md-6 col-lg-2">
                        {/* ABOUT US */}
                        <th href="#action/3.1" className="footH">ABOUT US</th>
                        <tr href="#action/3.1" className="footC">
                            About OLX Group
                        </tr>
                        <tr href="#action/3.1" className="footC">
                    ...
                    <td className="col-sm-12 col-md-6 col-lg-2">
                        {/* OLX */}
                        <th href="#action/3.1" className="footH">OLX</th>
                        <tr href="#action/3.1" className="footC">
                            Help
                        </tr>
                        <tr href="#action/3.1" className="footC">
                    ...
                    <td className="col-sm-12 col-md-6 col-lg-2">
                        ...
                        <tr href="#action/3.1" className="footC" style={{display : "flex", marginTop : "35px", marginLeft : "-3px"}}>
                            <a href="#" className="svgBtn">
                                <img src="https://statics.olx.com.pk/external/base/img/appstore_2x.webp" style={{ width: "86px", height: "26px" }} />
                            </a>
                            <a href="#" className="svgBtn">
                                <img src="https://statics.olx.com.pk/external/base/img/playstore_2x.webp" style={{ width: "86px", height: "26px" }} />
                            </a>
                        </tr>
                    </td>
                </table>
