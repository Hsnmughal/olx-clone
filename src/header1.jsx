...
import LoginAlternative from './afterloginalternative';
...
export default class Header extends React.Component {
    ...
    constructor() {
        super()
        this.state ={
            beforeLogin : <button className="btn btn-light login col-sm-12 col-md-12 col-lg-1" data-toggle="modal" data-target="#exampleModal"><span className='log'>Login</span></button>,
            afterLogin : ""
        }
    }
    render() {
                ...
                <Navbar bg="light" expand="lg" className="stickyNavbar">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="mr-auto container-fluid">
                            ...
                            <LoginAlternative pass={this.props.Objj}/>
                            ...
                            <Nav.Link href="/cardform"><button className="sell col-sm-12 col-md-12 col-lg-1"><img src={sellbtn} width='96px' height='48px'></img></button></Nav.Link>
                        </Nav>
                    </Navbar.Collapse>
                </Navbar>
                <div>
